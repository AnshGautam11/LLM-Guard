...
const MODELS = [
  ...
  { id: "grok-4.3", label: "Grok 4.3", vendor: "xAI" },
  { id: "deepseek-v4", label: "DeepSeek V4", vendor: "DeepSeek" },
  { id: "qwen-3.7-max", label: "Qwen 3.7 Max", vendor: "Alibaba" },
  { id: "llama-4", label: "Llama 4", vendor: "Meta" },
  { id: "mistral-medium-3.5", label: "Mistral Medium 3.5", vendor: "Mistral AI" },
  { id: "glm-5.1", label: "GLM-5.1", vendor: "Z.AI" },
  { id: "kimi-k3", label: "Kimi K3", vendor: "Moonshot AI" },
];
...
function Dashboard() {
  ...
  return (
        ...
        >
          ...
          >
            Rate limiting, pattern firewall, an ML jailbreak classifier, PII
            redaction, the model call, then output validation on the way back.
            This console runs that sequence against the model you choose and shows
            you the verdict.
          </p>
